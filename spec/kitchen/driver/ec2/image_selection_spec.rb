...
describe "Default images for various platforms" do
  ...
  PLATFORM_SEARCHES = {
    ...
    "windows" => [
      ...
      { name: "name", values: %w{Windows_Server-*-RTM-English-*-Base-* Windows_Server-*-SP*-English-*-Base-* Windows_Server-*-R*_RTM-English-*-Base-* Windows_Server-*-R*_SP*-English-*-Base-*} },
    ],
    "windows-2008" => [
      { name: "owner-alias", values: %w{amazon} },
      { name: "name", values: %w{Windows_Server-2008-RTM-English-*-Base-* Windows_Server-2008-SP*-English-*-Base-*} },
    ],
    "windows-2012" => [
      { name: "owner-alias", values: %w{amazon} },
      { name: "name", values: %w{Windows_Server-2012-RTM-English-*-Base-* Windows_Server-2012-SP*-English-*-Base-*} },
    ],
    "windows-2012r2" => [
      { name: "owner-alias", values: %w{amazon} },
      { name: "name", values: %w{Windows_Server-2012-R2_RTM-English-*-Base-* Windows_Server-2012-R2_SP*-English-*-Base-*} },
    ],
    "windows-2012sp1" => [
      { name: "owner-alias", values: %w{amazon} },
      { name: "name", values: %w{Windows_Server-2012-SP1-English-*-Base-*} },
    ],
    "windows-2012rtm" => [
      { name: "owner-alias", values: %w{amazon} },
    ...
    "windows-2012r2sp1" => [
      { name: "owner-alias", values: %w{amazon} },
      { name: "name", values: %w{Windows_Server-2012-R2_SP1-English-*-Base-*} },
    ],
    "windows-2012r2rtm" => [
      { name: "owner-alias", values: %w{amazon} },
      { name: "name", values: %w{Windows_Server-2012-R2_RTM-English-*-Base-*} },
    ],
    "windows-x86_64" => [
      { name: "owner-alias", values: %w{amazon} },
      { name: "name", values: %w{Windows_Server-*-RTM-English-*-Base-* Windows_Server-*-SP*-English-*-Base-* Windows_Server-*-R*_RTM-English-*-Base-* Windows_Server-*-R*_SP*-English-*-Base-*} },
